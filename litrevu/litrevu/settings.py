...
SECRET_KEY = 'django-insecure-%d&9t-(&0_lbaf)33l)m+5rn##7y@p1$at&qe-1-xnpe5zxqt1'
...
# Configuration des fichiers media - utilisez un chemin absolu vers votre répertoire
MEDIA_URL = '/'
MEDIA_ROOT = os.path.join(BASE_DIR, '')  # Utilise la racine du projet
